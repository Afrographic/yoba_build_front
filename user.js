...
router.get("/user", Security.authenticateToken, async (req, res) => {
  try {
    ...
    let user_data = await Thoth_DB.get_data(
      "SELECT user.country_id,country_name,balance,country_flag,user_account_activated,user_email,user_school,user_id,user_fullname,user_avatar,user_bio,user_created_date FROM user,country WHERE user_id=:user_id and user.country_id=country.country_id",
      { user_id },
    );
...
router.get("/user/:user_id", Security.authenticateToken, async (req, res) => {
  try {
    ...
    let user_data = await Thoth_DB.get_data(
      "SELECT user.country_id,balance,country_name,country_flag,user_account_activated,user_email,user_school,user_id,user_fullname,user_avatar,user_bio,user_created_date FROM user,country WHERE user_id=:user_id and user.country_id=country.country_id",
      { user_id },
    );
