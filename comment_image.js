...
const {
  Comment_Image_Controller,
} = require("../controllers/comment_image_controller.js");
...
router.post("/comment_image", Security.authenticateToken, async (req, res) => {
  try {
    ...
    let comment_image_url = await Drive_Service.upload_file(
      req.files.file.name,
      req.files.file.data,
    );
    ...
    await Thoth_DB.post_data(
      "insert into comment_image(comment_id,comment_image_url,comment_image_size,comment_image_created_date,user_id) values(:comment_id,:comment_image_url,:comment_image_size,:comment_image_created_date,:user_id)",
      {
        comment_id,
        comment_image_url,
        comment_image_size,
        comment_image_created_date,
        user_id,
      },
    );
